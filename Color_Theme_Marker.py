...
# create buttons for each standard colors
...
# Intitionale a dictionary to hold all stored color
stored_colors = {}
stored_color = IntVar()
...
for i in range (6):
    ...
    # .cget() returns the value of a specific options.
    stored_colors[stored_color.get()] = [new_color_tuple.cget('text'), new_color_hex.cget("text")]
